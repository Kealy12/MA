...
# within N=847, 28 answers are infalid = NA
sum(is.na(tri_comp_all))
...
# nrep = 10 to ensure to ensure that the algorithm finds a global rather than local maximum of the log-likelihood function (greatest value)
lca <- poLCA(f1, data = tri_comp_raw, nclass = 5, na.rm = T, nrep = 10)
