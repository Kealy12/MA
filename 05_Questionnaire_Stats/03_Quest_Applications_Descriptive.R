...
apps <- quest_tri_extended[, .(v_265, v_266, v_267, v_268, v_269, v_270)]
...
plot_apps_GER <- ggplot(apps_summary, aes(x = reorder(Applications, Score_Int), y = dis_by_app, fill = Score_Factor)) +
...
plot_apps_GER
ggsave("plot_apps_GER.png", plot_apps_GER)
...
########################################################### NOT in paper: Scores by Cluster ###############################################################
